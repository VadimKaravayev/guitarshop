...
<head>
	<title>Cool Music Shop an Ecommerce</title>
	<!--/tags -->
...
<body>
	...
	<div class="header-most-top">
		<p>Music Offer Zone Top Deals & Discounts</p>
		<vk:lang/>
	</div>
	<div class="avatar">
	    <vk:login/>
			...
			<div class="col-md-4 logo_agile">
				<h1>
					<a href="index.html">
						...
						<span>M</span>usic
						<span>Sh</span>op
						<img src="images/string-instruments.png" alt=" ">
					</a>
				</h1>
			</div>
			<!-- header-bot -->
					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav menu__list">
								...
								<li class="">
									<a class="nav-stylehead" href="product">String Instruments</a>
								</li>
	...
	<div class="ads-grid">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">Our Cool Instruments
			...
			<div class="agileinfo-ads-display col-md-9">
				<div class="wrapper">
					...
					<div class="product-sec1">
						<h3 class="heading-tittle">Guitars</h3>
					...
					<div class="product-sec1 product-sec2">
						<div class="col-xs-7 effect-bg">
							...
							<h6>Enjoy our cool string instruments</h6>
							<p>Get Extra 10% Off</p>
						</div>
						<h3 class="w3l-nut-middle">Basses & Guitars</h3>
					...
					<!-- third section (oils) -->
					<div class="product-sec1">
						<h3 class="heading-tittle">Ukuleles</h3>
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
					...
					<div class="product-sec1">
						<h3 class="heading-tittle">Cellos</h3>
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
	...
	<footer>
		<div class="container">
			...
			<div class="footer-info w3-agileits-info">
				...
				<div class="col-sm-5 address-right">
					<div class="col-xs-6 footer-grids">
						...
						<ul>
							...
							<li>
								<a href="product.html">Basses</a>
							</li>
							<li>
								<a href="product.html">Violins</a>
							</li>
							<li>
								<a href="product2.html">Ukulele</a>
							</li>
							<li>
								<a href="product.html">Cellos</a>
							</li>
						</ul>
					</div>
				...
				<div class="col-sm-5 address-right">
					<div class="col-xs-6 footer-grids">
						...
						<ul>
							<li>
								<a href="product">String Instruments</a>
							</li>
							<li>
			...
			<div class="agile-sometext">
				<div class="sub-some">
					<h5>Online Instrument Shopping</h5>
				...
				<div class="sub-some">
					...
					<ul>
						<li>
							<a href="product.html">Alvarez</a>
						</li>
						<li>
							<a href="product.html">B.C. Rich</a>
						</li>
						<li>
							<a href="product.html">Blueridge</a>
						</li>
						<li>
							<a href="product.html">Breedlove</a>
						</li>
						<li>
							<a href="product.html">Carvin</a>
						</li>
						<li>
							<a href="product.html">Charvel</a>
						</li>
						<li>
							<a href="product.html">Cordoba</a>
						</li>
						<li>
							<a href="product.html">Daisy Rock</a>
						</li>
						<li>
							<a href="product2.html">Dean</a>
						...
						<li>
							<a href="product2.html">Epiphone</a>
						</li>
						<li>
							<a href="product2.html">Ernie Ball Music Man</a>
						</li>
						<li>
							<a href="product2.html">EVH</a>
						</li>
						<li>
							<a href="product.html">ESP and ESP LTD</a>
						</li>
						<li>
							<a href="product2.html">Fender</a>
						</li>
						<li>
							<a href="product2.html">Gibson</a>
						</li>
						<li>
							<a href="product.html">G&L</a>
						</li>
						<li>
							<a href="product.html">Godin</a>
						</li>
						<li>
							<a href="product.html">Gretsch</a>
						</li>
						<li>
							<a href="product.html">Guild</a>
						</li>
						<li>
							<a href="product.html">Ibanez</a>
						</li>
						<li>
							<a href="product.html">Jackson</a>
						</li>
						<li>
							<a href="product.html">Kramer</a>
						</li>
						<li>
							<a href="product.html">Martin</a>
						</li>
						<li>
							<a href="product.html">Ovation</a>
						</li>
						<li>
							<a href="product2.html">PRS</a>
						</li>
						<li>
							<a href="product2.html">Rainsong</a>
						</li>
						<li>
							<a href="product.html">Rickenbacker</a>
						</li>
						<li>
							<a href="product2.html">Schecter</a>
						</li>
						<li>
							<a href="product2.html">Seagull</a>
						</li>
						<li>
							<a href="product.html">Squier</a>
						</li>
						<li>
							<a href="product.html">Taylor</a>
						</li>
						<li>
							<a href="product.html">Washburn</a>
						</li>
						<li>
							<a href="product2.html">Yamaha</a>
						</li>
					</ul>
				</div>
				<!-- //brands -->
	...
	<div class="copy-right">
		<div class="container">
			<p>© 2018 Cool Music Shop. All rights reserved | Design by
...
<!--    <script src="js/myScript/formValidationJavascript.js"></script>-->

    <!-- //form validation -->

<!--    -->
    <!--<script src="js/myScript/formValidationJQuery.js"></script>-->

    <script src="js/myScript/priceSlider.js"></script>
